_base_ = '/home/ls/anaconda3/envs/mmselfsupv1/lib/python3.8/site-packages/mmdet/.mim/configs/pascal_voc/faster-rcnn_swin-c4_voc0712.py'
...
model = dict(
    backbone=dict(
        ...
        out_indices=(0, 1, 2, 3),
        #out_indices = (3,),
        init_cfg=dict(type='Pretrained', checkpoint='/media/ls/disk1/swin_tiny_patch4_window7_224.pth')),
    roi_head=dict(
...
auto_scale_lr = dict(enable=True, base_batch_size=16) #1211添加 可测试加和不加哪个性能更好
