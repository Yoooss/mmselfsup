_base_ = 'mmdet::pascal_voc/faster-rcnn_swin-pafpn_voc0712.py'
...
default_hooks = dict(checkpoint=dict(by_epoch=False, interval=2000, max_keep_ckpts=1, save_best='auto'))
